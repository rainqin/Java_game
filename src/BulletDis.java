...
public class BulletDis extends Thread{
	...
	public BulletDis (int sourceX,int sourceY, double angle, double range,BattlePlace p,int se,BattleShip tar) {
		...
		bullet = new Bullet(meLocX+50, meLocY+50, 20, 20,Color.RED);
		p.add(bullet);
		panel = p;
		this.angle = angle;
		target = tar;
